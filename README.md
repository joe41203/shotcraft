...
[Chrome ウェブストア](https://chromewebstore.google.com/detail/shotcraft/pkhbgheiebgdikjbhegjfbidgbphccfo)から「Chrome に追加」でインストールできます。
...
| `Esc` | 選択解除・クロップのキャンセル（未選択なら選択ツールへ） |
