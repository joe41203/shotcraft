...
- **スタイルのフライアウト（線種・矢印スタイル）**: 線系ツール（矢印・直線・矩形・楕円・ペン）を選ぶと、そのツールボタンの真下に小さなパネル（フライアウト）が現れ、線種（実線 / 破線）を選べます。矢印ツールのときは加えて矢印スタイル（片側 / 両側 / 曲線）も出ます。ツールを選んでいる間は出しっぱなしで、別のツールに切り替えると消えます。選択ツールで線系の図形を選ぶと、その図形を描くツールボタンの下に同じフライアウトが出て、そこからの変更はその図形へ即座に反映されます。
...
- **スタイルのフライアウト（線種・矢印スタイル）**: 線種と矢印スタイルは、線系ツールのボタンの真下に現れる小さなパネル（フライアウト）で選びます。線系ツール（矢印・直線・矩形・楕円・ペン）を選ぶと、そのツールボタンの下にフライアウトが出しっぱなしになり、別のツールに切り替えると消えます。選択ツールで線系の図形を選ぶと、その図形を描くツールボタンの下にフライアウトが出て、そこからの変更はその図形へ即座に反映されます。フライアウト内のボタンはキーボードでも操作でき（Tab でツールボタンの並びから到達）、画面端でははみ出さないよう位置を調整します。
